...
describe('Analysis', function () {
    ...
    describe('Income/Expense and Daily Balances', function () {
        beforeEach(async function () {
            ...
            await dsl.transactions.createTransaction({ account: 'account1', date: '2017-11-30', type: 'income', amount: 30 })
        ...
        it('should get income and expense breakdown', async function () {
            await dsl.analysis.verifyIncomeAndExpense({
                ...
                expected: [
                    ...
                    { start: '2017-09-11', end: '2017-09-13', month: 201709, income: 0, expense: 0, profit: 0, earmarkedIncome: -5000, earmarkedExpense: 8000, earmarkedProfit: 3000 },
                    { start: '2017-11-30', end: '2017-11-30', month: 201712, income: 30, expense: 0, profit: 30, earmarkedIncome: 0, earmarkedExpense: 0, earmarkedProfit: 0 },
                ],
            });
        });
        ...
        it('should get daily balances', async function () {
            await dsl.analysis.verifyDailyBalances({
                expected: [
                    ...
                    {
                        date: '2017-07-31',
                        balance: 1000 - 5000 + -10 + 100 + -50 + 500 + 500 + -250 + -600 + -700 + 300,
                        earmarked: 1000 + 2000 + 500 + -250 + 300,
                        investments: 0,
                    },
                    {
                        date: '2017-09-11',
                        balance: 1000 - 5000 + -10 + 100 + -50 + 500 + 500 + -250 + -600 + -700 + 300 - 5000,
                        earmarked: 1000 + 2000 + 500 + -250 + 300,
                        investments: 5000,
                    },
                    {
                    ...
                    {
                        date: '2017-09-13',
                        balance: 1000 - 5000 + -10 + 100 + -50 + 500 + 500 + -250 + -600 + -700 + 300 - 5000 + 2000,
                        earmarked: 1000 + 2000 + 500 + -250 + 300,
                        investments: 5000 - 2000,
                    },
                    {
                        date: '2017-11-30',
                        balance: 1000 - 5000 + -10 + 100 + -50 + 500 + 500 + -250 + -600 + -700 + 300 - 5000 + 2000 + 30,
                        earmarked: 1000 + 2000 + 500 + -250 + 300,
                        investments: 5000 - 2000,
                    },
                ],
