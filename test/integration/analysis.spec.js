...
describe('Analysis', function() {
    ...
    it('should get daily balances', async function() {
        await dsl.analysis.verifyDailyBalances({
            expected: [
                {date: '2017-05-31', balance: -4000, bestFit: -3853.91},
                {date: '2017-06-03', balance: -4000 + -10, bestFit: -3855.26},
                {date: '2017-06-30', balance: -4000 + -10 + 100 + -50, bestFit: -3867.41},
                {date: '2017-07-01', balance: -4000 + -10 + 100 + -50 + 500 + 500 + -250, bestFit: -3867.86},
                {date: '2017-07-15', balance: -4000 + -10 + 100 + -50 + 500 + 500 + -250 + -600, bestFit: -3874.16},
                {date: '2017-07-31', balance: -4000 + -10 + 100 + -50 + 500 + 500 + -250 + -600 + -700 + 300, bestFit: -3881.36},
            ]
        })
    });
