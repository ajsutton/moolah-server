...
describe('Earmark Management', function () {
  ...
  describe('Earmark CRUD', function () {
    it('should list earmarks', async function () {
      await dsl.earmarks.createEarmark({
        alias: 'earmark1',
        name: 'Earmark 1',
        balance: 0,
      });
    ...
    it('should modify an earmark', async function () {
      ...
      await dsl.earmarks.modifyEarmark({
        alias: 'earmark1',
        name: 'Modified Earmark',
      });
  ...
  describe('Savings Goals', function () {
    it('should create earmark with savings goal', async function () {
      await dsl.earmarks.createEarmark({
        ...
        savingsStartDate: '2017-06-01',
        savingsEndDate: '2018-01-01',
      });
      await dsl.earmarks.verifyEarmark({
        alias: 'earmark1',
        savingsTarget: 500000,
        savingsStartDate: '2017-06-01',
        savingsEndDate: '2018-01-01',
    ...
    it('should modify earmark to change savings goal', async function () {
      ...
      await dsl.earmarks.modifyEarmark({
        ...
        name: 'Foo',
        savingsTarget: 25000,
        savingsStartDate: '2018-06-01',
        savingsEndDate: '2018-02-01',
      });
      await dsl.earmarks.verifyEarmark({
        alias: 'earmark1',
        name: 'Foo',
