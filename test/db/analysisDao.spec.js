...
describe('Analysis DAO', function () {
  ...
  describe('Income and Expense', function () {
    beforeEach(async function () {
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-05-31', type: 'income', amount: 1000 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-05-31', type: 'expense', amount: -5000 })
      );

      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-06-03', type: 'income', amount: -10 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({
      ...
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-07-01', type: 'income', amount: 500 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-07-01', type: 'expense', amount: -250 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({
      ...
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-07-31', type: 'expense', amount: -700 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-07-31', type: 'income', amount: 300 })
      );
    });

    it('should get income and expense grouped by month', async function () {
      assert.deepEqual(
        await analysisDao.incomeAndExpense(userId, 31, '2017-01-01'),
        [
          {
            start: '2017-05-31',
            end: '2017-05-31',
    ...
    it('should get income and expense grouped by month using arbitrary month start offset', async function () {
      assert.deepEqual(
        await analysisDao.incomeAndExpense(userId, 15, '2017-01-01'),
        [
          {
            start: '2017-05-31',
            end: '2017-06-03',
  ...
  describe('Daily Profit and Loss', function () {
    beforeEach(async function () {
      ...
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-06-03', type: 'income', amount: 100 })
      );
      await transactionDao.create(
        userId,
        makeTransaction({ date: '2017-06-03', type: 'expense', amount: -50 })
      );
    ...
    it('should get daily profit and loss', async function () {
      assert.deepEqual(
        ...
        [
          {
            date: '2017-06-03',
            profit: String(-10 + 100 + -50),
            earmarked: '0',
            investments: '0',
          },
          {
            date: '2017-07-01',
            profit: String(500 + 500 + -250),
            earmarked: '0',
            investments: '0',
          },
          {
            date: '2017-07-31',
            profit: String(-700 + 300),
            earmarked: '0',
            investments: '0',
          },
        ]
    ...
    it('should calculate amount earmarked each day', async function () {
      ...
      assert.deepEqual(
        ...
        [
          ...
          {
            date: '2017-07-01',
            profit: String(500 + 500 + 500 + -250),
            earmarked: '500',
            investments: '0',
          },
          {
            date: '2017-07-31',
            profit: String(-700 + 300 + 100 + -50),
            earmarked: '50',
            investments: '0',
          },
        ]
  ...
  describe('Expense Breakdown', function () {
    ...
    it('should calculate expense breakdown by category', async function () {
      ...
      assert.deepEqual(
        await analysisDao.expenseBreakdown(userId, 31, '2017-06-01'),
        [
