...
describe('Account DAO', function() {
    ...
    it('should round trip accounts', async function() {
        const account = {id: '1', name: 'Account 1', type: 'bank', position: 7, hidden: false};
    ...
    it('should update existing accounts', async function() {
        const account = {id: '1', name: 'Account 1', type: 'bank', position: 3, hidden: false};
        const modifiedAccount = {id: '1', name: 'New Account Name', type: 'cc', position: 5, hidden: true};
        await accountDao.create(userId, account);
    ...
    it('should get an account by id', async function() {
        const account = {id: '1', name: 'Account 1', type: 'bank', position: 5, hidden: false};
        await accountDao.create(userId, account);
    ...
    it('should default position to 0', async function() {
        ...
        assert.deepEqual(result, {id: '1', name: 'Account 1', type: 'bank', position: 0, hidden: false});
    });

    it('should sort accounts by position then name', async function() {
        const account1 = {id: '1', name: 'Account 1', type: 'bank', position: 3, hidden: false};
        const account2 = {id: '2', name: 'Account 2', type: 'bank', position: 1, hidden: false};
        const account3 = {id: '3', name: 'B Account', type: 'bank', position: 5, hidden: false};
        const account4 = {id: '4', name: 'A Account', type: 'bank', position: 5, hidden: false};
        await Promise.all([
