...
describe('Get Transactions Handler', function() {
    ...
    it('should return the transaction when it exists', async function() {
        ...
        daos.transactions.transactions.withArgs(userId, {accountId: accountId, scheduled: false, from: undefined, to: undefined, categories: [], earmarkId: undefined}).resolves([transaction]);
        const response = await makeRequest(accountId);
